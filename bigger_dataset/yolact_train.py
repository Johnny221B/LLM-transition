...
parser.add_argument('--config', default="yolact_resnet50_pascal_config",
...
def train():
    ...
    num_epochs = 1  # math.ceil(cfg.max_iter / epoch_size)
    cfg.max_iter = num_epochs * epoch_size
...
def prepare_data(datum, devices: list = None, allocation: list = None):
    with torch.no_grad():
        ...
        for device_idx, alloc in enumerate(allocation):
            split_images[device_idx] = torch.stack(list(images[cur_idx:cur_idx + alloc]), dim=0)
