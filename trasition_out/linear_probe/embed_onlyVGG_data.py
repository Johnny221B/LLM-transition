...
patience = 30
train_pic_file = 'pic_result/training_predictions_onlyVGGdata_modify.png'
test_pic_file = 'pic_result/testing_predictions_onlyVGGdata_modify.png'
weight_name = 'linear_probe_weights_onlyVGGdata_modify.pth'
embedding_path = '/home/jingxuan/linear_probing/embeddings_onlyVGGdata_starcoder/'
hidden_size = 512
hidden_size2 = 1024
weight_decay = 1e-4
lambda_l1 = 1e-4
code_name = f'testVGG-trainovlyVGG-patience{patience}-bs{batch_size}-lr{learning_rate}-hs{hidden_size}-wd{weight_decay}-l1{lambda_l1}-mse-reduceLR-layer3'
# ExponentialLR
