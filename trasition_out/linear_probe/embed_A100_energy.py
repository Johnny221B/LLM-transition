...
merge_file = f'A100energy/merge_predictions_A100energy_{run_type}.png'
...
negative_indices = merged_predictions < 0
merged_predictions[negative_indices] = np.random.randint(50000, 100000, size=negative_indices.sum())
...
plot_predictions(merged_predictions, merged_actuals, 'Testing Data Predictions',merge_file)
print(code_name)