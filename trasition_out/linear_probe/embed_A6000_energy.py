...
train_pic_file = f'A6000energy/training_predictions_A6000energy_{run_type}.png'
test_pic_file = f'A6000energy/testing_predictions_A6000energy_{run_type}.png'
weight_name = f'A6000energy/linear_probe_weights_A6000energy_{run_type}.pth'
embedding_path = f'/home/jingxuan/linear_probing/embeddings_A6000_energy_{run_type}/'
hidden_size = 512
hidden_size2 = 1024
weight_decay = 2e-4
lambda_l1 = 2e-4
code_name = f'A6000energy-bs{batch_size}-lr{learning_rate}-hs{hidden_size}-wd{weight_decay}-l1{lambda_l1}-{run_type}'
