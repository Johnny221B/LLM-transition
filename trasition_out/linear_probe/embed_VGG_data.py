...
weight_decay = 2e-4
lambda_l1 = 2e-4
code_name = f'testVGG-trainVGG-patience{patience}-bs{batch_size}-lr{learning_rate}-hs{hidden_size}-wd{weight_decay}-l1{lambda_l1}-mse-reduceLR-layer3'
# ExponentialLR
