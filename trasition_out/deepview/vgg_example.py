...
test_combinations = {
    "test1": {"batch_size": 8, "epoch": 60},
    "test2": {"batch_size": 32, "epoch": 70},
    "test3": {"batch_size": 16, "epoch": 105},
    "test4": {"batch_size": 64, "epoch": 45},
    "test5": {"batch_size": 32, "epoch": 25},
    "test6": {"batch_size": 16, "epoch": 40},
    "test7": {"batch_size": 32, "epoch": 45},
    "test8": {"batch_size": 16, "epoch": 55}
    # 你可以根据需要添加更多的组合
}
