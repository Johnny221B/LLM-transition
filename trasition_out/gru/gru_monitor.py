...
tasks = [
    # "python train_gru0.py --cuda_device 7",
    # "python train_gru1.py --cuda_device 7",
    # "python train_gru2.py --cuda_device 7",
    # "python train_gru3.py --cuda_device 7",
    # "python train_gru4.py --cuda_device 7",
    # "python train_gru5.py --cuda_device 7",
    "python train_gru6.py --cuda_device 6",
    "python train_gru7.py --cuda_device 6"
    # "python train_gru8.py --cuda_device 7",
    # "python train_gru9.py --cuda_device 7"
]
