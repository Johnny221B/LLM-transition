...
if __name__ == '__main__':
    ...
    parser.add_argument('--model', type=str, default='densenet121',
                        ...
                        help='使用的模型名称或路径，例如 densenet201 或 ./saved_models/model_weights.pth（默认: densenet121）。 .pth 文件应包含模型权重名称，如 densenet121_time.pth')
    ...
    parser.add_argument('--num_epochs', type=int, default=100, help='训练的轮数（默认: 1）')
